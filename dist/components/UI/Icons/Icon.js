...
var getViewBox = function getViewBox(viewBox, width, height) {
  if (viewBox) {
    return "0 0 ".concat(viewBox, " ").concat(viewBox);
  }

  return "0 0 ".concat(width, " ").concat(height || width);
};
  ...
  switch (name) {
    ...
    case 'certificate':
      return React.createElement("g", Object.assign({}, props, {
        ...
        d: "M15 8h-2V4.618l.553.277a1 1 0 1 0 .894-1.79l-6-3a1 1 0 0 0-.894 0l-6 3a1 1 0 0 0 .894 1.79L3 4.618V8H1a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6v-4h2v4h6a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1zM5 13H3v-3h2v3zm0-5V4a.98.98 0 0 0-.07-.347L8 2.118l3.07 1.535A.98.98 0 0 0 11 4v4H5zm8 5h-2v-3h2v3z"
      }));
    ...
    case 'information-welcome':
      ...
      })), React.createElement("path", Object.assign({}, props, {
        fillRule: "nonzero",
    ...
    case 'letter':
      return React.createElement("g", Object.assign({}, props, {
        ...
        d: "M15 2H1c-.6 0-1 .4-1 1v1.4l8 4.5 8-4.4V3c0-.6-.4-1-1-1z"
      }), React.createElement("path", {
        d: "M7.5 10.9L0 6.7V15c0 .6.4 1 1 1h14c.6 0 1-.4 1-1V6.7l-7.5 4.2c-.28.14-.72.14-1 0z"
      }));
    ...
    case 'blocked isTest':
      return React.createElement("g", props, React.createElement("path", {
        fillRule: "nonzero",
        d: "M3.5 7h9a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1h-9a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1z"
      }), React.createElement("path", {
        d: "M2.5 4h11v2h-11z"
      }), React.createElement("path", {
        d: "M5.5 2a1 1 0 0 1 1 1v2h-2V3a1 1 0 0 1 1-1zM10.5 2a1 1 0 0 1 1 1v2h-2V3a1 1 0 0 1 1-1z"
      }));
    ...
    case 'download':
      return React.createElement("g", Object.assign({}, props, {
        ...
        d: "M7 12c.3 0 .5-.1.7-.3L13.4 6 12 4.6l-4 4V0H6v8.6l-4-4L.6 6l5.7 5.7c.2.2.4.3.7.3zM0 14h14v2H0z"
      }));
    ...
    case 'reading':
      return React.createElement("g", Object.assign({}, props, {
        ...
        d: "M5 6H1c-.6 0-1-.4-1-1V1c0-.6.4-1 1-1h4c.6 0 1 .4 1 1v4c0 .6-.4 1-1 1zM8 0h8v2H8zM8 4h8v2H8zM0 8h16v2H0zM0 12h16v2H0z"
      }));
    ...
    case 'edit':
      return React.createElement("g", Object.assign({}, props, {
        ...
        d: "M0 14h16v2H0zM11.7 3.3c.4-.4.4-1 0-1.4L10.1.3c-.4-.4-1-.4-1.4 0L0 9v3h3l8.7-8.7z"
      }));
    ...
    case 'circularCheck':
      return React.createElement("g", Object.assign({}, props, {
        ...
        width: "17",
        height: "17",
        fill: _variables.default.setColors.checkGreen,
        rx: "8.5"
      }), React.createElement("path", {
        fill: "#FFF",
        fillRule: "nonzero",
    ...
    case 'circularError':
      return React.createElement("g", Object.assign({}, props, {
        ...
        width: "17",
        height: "17",
        fill: _variables.default.setColors.checkError,
        rx: "8.5"
      }), React.createElement("g", {
        stroke: "#FFF",
        ...
        d: "M5.474 5.555l6.24 5.941M5.34 11.544l6.035-6.153"
      })));
    ...
    case 'menuListItems':
      return React.createElement("g", Object.assign({}, props, {
        ...
        d: "M6 1h10v2H6zM6 7h10v2H6zM6 13h10v2H6zM3 0H1C.4 0 0 .4 0 1v2c0 .6.4 1 1 1h2c.6 0 1-.4 1-1V1c0-.6-.4-1-1-1zM3 6H1c-.6 0-1 .4-1 1v2c0 .6.4 1 1 1h2c.6 0 1-.4 1-1V7c0-.6-.4-1-1-1zM3 12H1c-.6 0-1 .4-1 1v2c0 .6.4 1 1 1h2c.6 0 1-.4 1-1v-2c0-.6-.4-1-1-1z"
      }));
    ...
    case 'arrow-top-right':
      return React.createElement("g", Object.assign({}, props, {
        ...
        d: "M6.793 2.793L.586 9 2 10.414l6.207-6.207L11 7V0H4z"
      }));
    ...
    default:
      return React.createElement("path", null);
  }
};
...
var Icon = function Icon(_ref) {
  ...
  if (_variables.default.setColors[fill]) {
    fill = _variables.default.setColors[fill];
  }
...
var StyledSVG = _styledComponents.default.svg(_templateObject(), function (_ref2) {
  var className = _ref2.className;
  return className && className.split(' ').includes('arrow-icon') ? 0 : '10px';
}, function (_ref3) {
  var height = _ref3.height,
      width = _ref3.width;
  return height ? "".concat(height, "px") : "".concat(width, "px");
}, function (_ref4) {
  var width = _ref4.width;
  return width ? "".concat(width, "px") : '16px';
}); // @PropTypes