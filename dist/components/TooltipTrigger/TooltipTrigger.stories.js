...
var _ProgressIcon = _interopRequireDefault(require("../ProgressIcon/ProgressIcon"));
...
var _default = {
  ...
  parameters: {
    component: _TooltipTrigger.default,
...
var hoverAndPosition = function hoverAndPosition() {
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_ProgressIcon.default, {
    color: "white",
    bgcolor: _variables.default.setColors.deepSkyBlue,
    icon: "in-progress",
    id: "Tooltip-in-progress"
  }), _react.default.createElement(_TooltipTrigger.default, {
    placement: "top",
    trigger: "hover",
    target: "in-progress"
  }, 'Visto 0 de 4 contenidos'), _react.default.createElement(_ProgressIcon.default, {
    color: "white",
    bgcolor: _variables.default.setColors.deepSkyBlue,
    icon: "opened",
    id: "Tooltip-opened"
    ...
    trigger: "hover",
    target: "opened"
  }, 'Unidad Liberada'), _react.default.createElement(_ProgressIcon.default, {
    color: "white",
    bgcolor: "orange",
    icon: "blocked",
    id: "Tooltip-blocked"
    ...
    trigger: "hover",
    target: "blocked"
  }, 'Para continuar debes completar la unidad anterior'), _react.default.createElement(_ProgressIcon.default, {
    color: "white",
    bgcolor: "#5E7A8C",
    icon: "done",
    id: "Tooltip-done"
